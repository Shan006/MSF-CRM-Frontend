      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 -mb-px">
          ...
          {/* <div className=" sm:block lg:block xl:block md:block hidden  ">
            <ul className="flex text-[#92CDFF]">
              <li className="px-2 cursor-pointer">
                <Link to="/ecommerce/customers">Leads</Link>
              </li>
              <li className="px-2 cursor-pointer">
                <Link to="/ecommerce/customers">Application</Link>
              </li>
              <li className="px-2 cursor-pointer">
                <Link to="/ecommerce/customers">Loans</Link>
              </li>
              <li className="px-2 cursor-pointer">
                <Link to="/ecommerce/customers">Contacts</Link>
              </li>
            </ul>
          </div> */}
          {/* Header: Right side */}
