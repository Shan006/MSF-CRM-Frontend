      ...
      <div className="flex h-screen overflow-hidden">
        ...
        {/* calls email  */}
          <div className=' w- h-[60px]   bg-[#343D46] border   border-b border-gray-900 my-6 ml-2 mr-2 ' >
           ...
           {/* portal invite sec */}
           <div className=' w- h-[120px]   bg-[#FFFFFF] border   border-b border-gray-900  ml-2 mr-2 ' >
            <div className='w-full  flex  lg:flex-row md:flex-col    justify-between   h-full'>
            <div className="flex  w-3/4 justify-evenly items-center ">
           {/* <div className='h-full flex items-center ' >Lorenza Valencia</div> */}
           <div className='h-full w-[50px] rounded-full  items-center flex justify-center' >Calls</div>
           <div className='h-full w-[50px] rounded-full  items-center flex justify-center' >Email</div>
           <div className='h-full w-[50px] rounded-full  items-center flex justify-center' >Text</div>
           <div className='h-full w-[50px] rounded-full  items-center flex justify-center' >Task</div>
