          ...
          <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <table className="min-w-full divide-y divide-gray-200 ml-2">
              ...
              <div className="w-[300px] mx-2 pb-4  ">
                  <div className=" flex items-center  justify-center rounded-md p-2 border-slate-500 border-dashed  ">
                    <GrAddCircle className="inline-flex items-center justify-center w-4 h-4 text-gray-600"/>
                    <button
