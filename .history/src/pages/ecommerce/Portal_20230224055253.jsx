...
// const RC = import('@ringcentral/sdk').SDK;
const Portal = () => {
  // states
  ...
  const RECIPIENT    =import.meta.env.RINGOUT_RECIPIENT
  ...
  // Ring central UseEffect
// useEffect(()=>{
//   var rcsdk = new RC({
//     'server':import.meta.env.RC_SERVER_URL,
//     'clientId':import.meta.env.RC_CLIENT_ID,
//     'clientSecret':import.meta.env.RC_CLIENT_SECRET
// })
// var platform = rcsdk.platform()
// platform.login({
//     'username':import.meta.env.RC_USERNAME,
//     'password':import.meta.env.RC_PASSWORD,
//     'extension':import.meta.env.RC_EXTENSION
// })
...
// send mail button function
  ...
  // send lead link via Email
  const SendLeadLinkViaEmail=async()=>{
  // const result=await axios.post(`${import.meta.env.VITE_BACKEND_URL}/lead/referral`,{
  //   leadId:"63f64a836c6029428bf4b3b6"
  // });
          ...
          <div className=" w- h-[60px]     my-6 ml-2 pr-2 ">
            <div className="w-full  flex  lg:flex-row md:flex-col    justify-between   h-full">
              <div className="flex  w-3/4 justify-evenly items-center ">
                ...
                <div className="h-[40px] w-[40px] rounded-md hover:bg-[#058cc1] bg-[#1d4189] items-center flex justify-center cursor-pointer" onClick={call_ringout}>
                ...
                <div className="h-[40px] w-[40px] rounded-md hover:bg-[#058cc1] bg-[#1d4189] items-center flex justify-center cursor-pointer" onClick={openTaskModal}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4  justify-evenly py-4">
              ...
              >
                <ul className="flex-col ">
                  <li className="cursor-pointer text-[#788AB8] pt-2 hover:text-[#1b4ac0]" onClick={SendLeadLinkViaEmail}>
                    Send via Email
                  </li>
