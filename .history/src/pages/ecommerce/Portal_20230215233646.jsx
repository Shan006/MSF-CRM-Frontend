      ...
      <div className="flex h-screen overflow-hidden">
        ...
        {/* calls email  */}
          <div className=' w- h-[60px]    border   border-b border-gray-900 my-6 ml-2 mr-2 ' >
           ...
           <div className='h-[40px] w-[40px] rounded-md bg-[#FF7043] items-center flex justify-center cursor-pointer' ><BsTelephone className="h-6 w-6 text-white "/></div>
           <div className='h-[40px] w-[40px] rounded-md bg-[#FF7043] items-center flex justify-center cursor-pointer' ><AiOutlineMail className="h-6 w-6 text-white"/></div>
           <div className='h-[40px] w-[40px] rounded-md bg-[#FF7043] items-center flex justify-center cursor-pointer' ><BiMessageDots className="h-6 w-6 text-white"/></div>
           <div className='h-[40px] w-[40px] rounded-md bg-[#FF7043] items-center flex justify-center cursor-pointer' ><VscTasklist className="h-6 w-6 text-white"/></div>

          
           </div>
           <div className="flex   justify-evenly items-center ">
           <div className='h-full flex items-center text-black text-lg font-bold mr-4' >Lorenza Valencia</div>
           <div className='h-full w-[60px] rounded-full bg-[#2E66F6] items-center flex justify-center text-lg font-bold text-white' >LV</div>
           </div>
           </div>
           </div>
...
<div className='  lg:h-[120px] h-[150px]   bg-[#ffffffec] border   border-b border-gray-900  ml-2 mr-2 ' >
           ...
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg ">
            <HiOutlineDocumentCheck className="w-8 h-8 text-yellow-700 inline-flex mx-1"/>Docs Owed</p>
            <p className="text-3xl font-bold">0</p>
           </div>
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg "><HiOutlineDocumentCheck className="w-8 h-8 text-yellow-700 inline-flex mx-1"/>Docs Pending Review</p>
            <p className="text-3xl font-bold">0</p>
           </div>
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg "><HiOutlineDocumentCheck className="w-8 h-8 text-yellow-700 inline-flex mx-1"/>Docs Accepted</p>
            <p className="text-3xl font-bold">0</p>
           </div>
           </div>
           </div>
