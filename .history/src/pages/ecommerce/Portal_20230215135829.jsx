...
import {HiOutlineDocumentMagnifyingGlass,HiOutlineDocumentCheck} from 'react-icons/hi'
...
<div className='  lg:h-[120px] h-[150px]   bg-[#ffffffec] border   border-b border-gray-900  ml-2 mr-2 ' >
           ...
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg "><HiOutlineDocumentCheck className="inline-flex h-8 w-8 mr-1 text-red-500"/>Docs Owed</p>
            <p className="text-3xl font-bold text-[#263238]">0</p>
           </div>
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg "><HiOutlineDocumentMagnifyingGlass className="inline-flex h-8 w-8 mr-1 text-yellow-300"/>Docs Pending Review</p>
            <p className="text-3xl font-bold text-[#263238]">0</p>
           </div>
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg "><HiOutlineDocumentCheck className="inline-flex h-8 w-8 mr-1 text-green-500"/>Docs Accepted</p>
            <p className="text-3xl font-bold text-[#263238]">0</p>
           </div>
           ...
           <div className='  lg:h-[120px] h-[150px]   bg-[#ffffffec] border   border-b border-gray-900  ml-2 mr-2 ' >
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3  justify-evenly py-4">
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg ">Default Needs List <IoIosArrowDown className={`h-6 w-6 `}/></p>
