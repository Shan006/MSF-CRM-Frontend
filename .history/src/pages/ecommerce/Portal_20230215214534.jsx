...
// import {HiOutlineDocumentMagnifyingGlass} from 'react-icons/hi'
...
<div className='  lg:h-[120px] h-[150px]   bg-[#ffffffec] border   border-b border-gray-900  ml-2 mr-2 ' >
           ...
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg cursor-pointer ">Docs Type<IoIosArrowDown className={`inline-flex hover:rotate-180 h-3 w-3`}/></p>
           
           </div>
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg cursor-pointer">Docs Name<IoIosArrowDown className={`inline-flex hover:rotate-180 h-3 w-3`}/></p>
          
           </div>
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg cursor-pointer ">Status<IoIosArrowDown className={`inline-flex hover:rotate-180 h-3 w-3`}/></p>
           
           </div>
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg cursor-pointer ">Date <IoIosArrowDown className={`inline-flex hover:rotate-180 h-3 w-3`}/></p>
           
           </div>
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg cursor-pointer ">Action <IoIosArrowDown className={`inline-flex hover:rotate-180 h-3 w-3`}/></p>
