        ...
        {/* calls email  */}
          <div className=' w- h-[60px]     my-6 ml-2 mr-2 ' >
           ...
           <div className="">
                ...
                {/* invite toggle  */}
                <div className={`bg-[#FFFFFF] right-72 top-56 w-[150px] h-[150px] ${sendInviteToggle?'absolute  ':'hidden' }`}>
                <Transition
...
<div className='  lg:h-[120px] h-[150px]   bg-[#ffffffec] border   border-b border-gray-900  ml-2 mr-2 ' >
           ...
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg cursor-pointer " onClick={()=>setdocTempToggle(!docTempToggle)}>Default Needs List <IoIosArrowDown className={`inline-flex hover:rotate-180 h-6 w-6`}/>
               ...
               {/* invite toggle  */}
               <div className={`bg-[#ffffff0a]   w-[150px] h-[150px] ${setdocTempToggle?'absolute  ':'hidden' }`}>
                <Transition
                  show={docTempToggle}
                  enter="transition ease-out duration-300 transform"
                  enterFrom="opacity-0 scale-95"
                ...
                >
                  {/* <ul className="flex-col ">
                    <li className="cursor-pointer text-[#788AB8] pt-2 hover:hover:text-[#c07229]">Default Needs Lists</li>
                    <li className="cursor-pointer text-[#788AB8] pt-2 hover:hover:text-[#c07229] uppercase">p</li>
                    <li className="cursor-pointer text-[#788AB8] pt-2 hover:hover:text-[#c07229]">Copy Portal Link</li>

                  </ul> */}
                  <select name="PreTempDocs" >
                       <option value="volvo" className="cursor-pointer text-[#788AB8] pt-2 hover:hover:text-[#c07229]">Volvo</option>
                       <option value="saab" className="cursor-pointer text-[#788AB8] pt-2 hover:hover:text-[#c07229]">Saab</option>
                        <option value="mercedes" className="cursor-pointer text-[#788AB8] pt-2 hover:hover:text-[#c07229]">Mercedes</option>
                        <option value="audi" className="cursor-pointer text-[#788AB8] pt-2 hover:hover:text-[#c07229]">Audi</option>
</select>
