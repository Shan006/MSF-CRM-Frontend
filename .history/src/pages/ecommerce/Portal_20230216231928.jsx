            ...
            <table className="min-w-full divide-y divide-gray-200 ml-2">
              ...
              <tr className="pt-2" >
                    <td className="px-6  whitespace-nowrap">
                      <input type="checkbox"  selected name="" value="" className={` mx-2 ${item.status?'checked:bg-blue-500':''}`}/>
                      <label for="vehicle1">{item.data}</label>
                    </td>
                    <td className="px-6  whitespace-nowrap">
                      <div className="text-sm text-gray-900">{item.status?<AiOutlineCloudUpload className="h-8 w-8 cursor-pointer"/>:''}</div>
                    </td>                   
                  </tr>
                )}
