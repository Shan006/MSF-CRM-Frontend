          ...
          <div className=" w- h-[60px]     my-6 ml-2 pr-2 ">
            <div className="w-full  flex  lg:flex-row md:flex-col    justify-between   h-full">
              <div className="flex  w-3/4 justify-evenly items-center ">
                ...
                <div className="h-[40px] w-[40px] rounded-md hover:bg-[#058cc1] bg-[#058cc1] items-center flex justify-center cursor-pointer">
              ...
              <div className="flex   justify-evenly items-center ">
                ...
                <div className="h-full w-[55px] rounded-full bg-[#2E66F6] items-center flex justify-center text-lg font-bold text-white">
                  LV
                </div>
              </div>
            </div>
          ...
          <div className="   h-auto   bg-[#ffffffec] border   border-b border-gray-900  ml-2 mr-2 ">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4  justify-evenly py-4">
              <div className="h-full w-full flex-col flex  items-center ">
                <p className="text-[#788AB8] text-sm">Portal Invite Date</p>
                <p className="text-xl font-bold">-/--/----</p>
              </div>
              <div className="h-full w-full flex-col flex  items-center">
                <p className="text-[#788AB8] text-sm">Application Completion Date</p>
                <p className="text-xl font-bold">-/--/----</p>
              </div>
              <div className="h-full w-full flex-col flex  items-center">
                <p className="text-[#788AB8] text-sm">Status</p>
              </div>
              <div className="">
