      ...
      <div className="flex h-screen overflow-hidden">
        ...
        {/* calls email  */}
          <div className=' w- h-[60px]   bg-[#343D46] border   border-b border-gray-900 my-6 ml-2 mr-2 ' >
           ...
           <div className='h-full  rounded-full  items-center flex justify-center' >Email</div>
           <div className='h-full rounded-full  items-center flex justify-center' >Text</div>
           <div className='h-full  rounded-full  items-center flex justify-center' >Task</div>
