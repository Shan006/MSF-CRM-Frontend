          ...
          <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <table className="min-w-full divide-y divide-gray-200 ml-2">
              ...
              <div className="w-[300px] mx-2 pb-4  ">
                  <div className=" flex items-center  justify-center rounded-md p-2 border-dashed border-2 border-gray-600  ">
                    <GrAddCircle className="inline-flex  w-4 h-4 text-gray-600"/>
                    <button
                      className="text-lg text-slate-500 font-semibold hover:scale-95 "
                      //  onClick={() => setSendInviteToggle(!sendInviteToggle)}
                    >
                      Add Custom Doc
                    </button>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 pb-4 px-2">
                  <div className="flex items-center cursor-pointer">
                   ...
                   <p className="text-xs"> Allow referral partner to generate pre-approval letters</p>
                    </div>
                ...
                <div className="w-[300px] mx-2 pb-4  ">
                  <div className=" flex  justify-center rounded-md p-2 bg-[#78889B]  hover:bg-[#637386]">
                    <button
