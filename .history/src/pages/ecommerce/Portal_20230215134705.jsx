...
<div className='  lg:h-[120px] h-[150px]   bg-[#ffffffec] border   border-b border-gray-900  ml-2 mr-2 ' >
           ...
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg "><GrDocumentVerified className="inline-flex h-8 w-8 mr-1 text-yellow-300"/>Docs Pending Review</p>
            <p className="text-3xl font-bold">0</p>
           </div>
           <div className='h-full w-full flex-col flex  items-center' >
            <p className="text-[#ACBEC8] text-lg "><GrDocumentVerified className="inline-flex h-8 w-8 mr-1 text-yellow-300"/>Docs Accepted</p>
            <p className="text-3xl font-bold">0</p>
           </div>
