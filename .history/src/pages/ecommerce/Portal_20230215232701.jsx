      ...
      <div className="flex h-screen overflow-hidden">
        ...
        {/* calls email  */}
          <div className=' w- h-[60px]    border   border-b border-gray-900 my-6 ml-2 mr-2 ' >
           ...
           <div className='h-[40px] w-[50px] rounded-md bg-[#FF7043] items-center flex justify-center cursor-pointer' ><BsTelephone className="h-8 w-8 text-white "/></div>
           ...
           <div className='h-[50px] w-[50px] rounded-md bg-[#FF7043] items-center flex justify-center cursor-pointer' ><VscTasklist className="h-8 w-8 text-white"/></div>
