...
const Portal = () => {
  ...
  const SendMail= ()=>{
    ...
    //   const respo=await axios.post(`${process.env.REACT_APP_BACKEND_URL}/conversation/send`,
    //   {
    //     email:emailForm.to,
    ...
    // }
      // axios.post(`${process.env.REACT_APP_BACKEND_URL}/conversation/send`)
  }
}
  useEffect(()=>{
    arr.map((item)=>{
...
console.log("backend uri:",process.env.REACT_APP_BACKEND_URL);
 ...
 {/* modal */}
        ...
        <ModalFooter>
        <Button className="w-full sm:w-auto" layout="outline" onClick={SendMail}>
            Send
          </Button>
