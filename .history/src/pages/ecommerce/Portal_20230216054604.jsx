               ...
               <div className={`bg-[#ffffff0a] top-[430px] left-24  w-[250px] h-auto ${setdocTempToggle?'absolute  ':'hidden' }`}>
                ...
                >
                  ...
                  <select name="PreTempDocs" className="w-full">
                       ...
                       <option value="saab" className="cursor-pointer text-[#788AB8] pt-2 hover:hover:text-[#c07229]">purchase documents for w-2 and 1099 Employees</option>
                        <option value="mercedes" className="cursor-pointer text-[#788AB8] pt-2 hover:hover:text-[#c07229]">purchase documents for w-2 and 1099 Employees va loans</option>
