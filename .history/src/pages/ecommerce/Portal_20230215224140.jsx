            ...
            <table className="min-w-full divide-y divide-gray-200 ml-2">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th
                    scope="col"
                    className=" py-3 text-left  font-medium text-gray-500  tracking-wider"
                  >
                   Docs Name
                   <IoIosArrowDown className={`inline-flex hover:rotate-180 h-3 w-3`}/>
                  </th>
              ...
              <tr >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">usman  saldjaskdhashdsd klasd asldha dasjkahdasdlas asdjhasd asldhas dasldhasdasklasd</div>
