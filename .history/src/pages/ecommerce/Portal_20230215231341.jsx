      ...
      <div className="flex h-screen overflow-hidden">
        ...
        {/* calls email  */}
          <div className=' w- h-[60px]   bg-[#343D46] border   border-b border-gray-900 my-6 ml-2 mr-2 ' >
           ...
           <div className='h-[50px] w-[50px] rounded-md bg-[#FF7043] items-center flex justify-center' ><BsTelephone className="h-8 w-8 text-white bg-white"/></div>
           <div className='h-[50px] w-[50px] rounded-md bg-[#FF7043] items-center flex justify-center' >Calls</div>
           <div className='h-[50px] w-[50px] rounded-md bg-[#FF7043] items-center flex justify-center' >Calls</div>
           <div className='h-[50px] w-[50px] rounded-md bg-[#FF7043] items-center flex justify-center' >Calls</div>
